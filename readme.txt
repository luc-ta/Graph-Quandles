...
As an example of how to use rack-labels.txt, here's what you would input to compute the numbers of rack and quandle structures realizable by cycle graphs C_n of orders 3 to 6; replace "[PATH]" with the path to whereever you've saved rack-labels.txt on your computer:
